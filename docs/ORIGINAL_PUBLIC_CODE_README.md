...
> **Release status: PUBLIC CODE RELEASE v1.0.1 (2026-08-04).** This code
> release is independent of journal submission; the manuscript has not yet been
> submitted. The repository contains the verified analysis code, synthetic
> workflow, frozen-result checks, and release documentation.
